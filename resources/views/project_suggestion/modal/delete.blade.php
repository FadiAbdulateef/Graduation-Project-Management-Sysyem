    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('suggestion.destroy', $project->id)}}" method="post" autocomplete="off">
                    @method('DELETE')
                    @csrf
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">سيتم حذف المشروع بشكل نهائي، هل انت متأكد من عملية الحذف؟ </label>
                    </div>
