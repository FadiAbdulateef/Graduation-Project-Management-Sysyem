<div class="modal fade" id="delete{{ ($supervisor->id) }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if($supervisor->user_id)
                    <form action="{{ route('supervisor.destroy', $supervisor->user_id)}}" method="post"
                          autocomplete="off">
                        @method('DELETE')
                        @csrf
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">سيتم حذف السجل بشكل نهائي، هل انت متأكد
                                من ذلك؟ </label>
                ...
                @else
                    <form action="{{ route('supervisor.destroy', $supervisor->id)}}" method="post" autocomplete="off">
                        @method('DELETE')
                        @csrf
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">سيتم حذف السجل بشكل نهائي، هل انت متأكد
