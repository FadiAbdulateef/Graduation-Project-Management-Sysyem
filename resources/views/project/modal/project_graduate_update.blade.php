<div class="modal fade" id="project_graduate_update{{ $project->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('project.project_graduate_update',$project->id)}}" method="post" autocomplete="on">
                    @method('PUT')
                    @csrf
