            ...
            <div class="modal-body">
                ...
                <form action="{{ route('project_interview.store') }}" method="post" autocomplete="on">
                    ...
                    <div class="form-group">
                        ...
                        <select name="interview_type" class="capitalize block mt-1 w-full" style="border: 1px solid #cccccc; border-radius: 5px;width: 100%">
{{--                            <option value="project_id" selected="selected" disabled></option>--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="select2-purple">
                            <select name="interviewers[]" class="select2" multiple="multiple" data-placeholder=""
