<div class="modal fade" id="delete{{ ($project_interview->id) }}" tabindex="-1" role="dialog"
     aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">حذف مناقشة </h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('project_interview.destroy', $project_interview->id)}}" method="post" autocomplete="off">
                    @method('DELETE')
                    @csrf
